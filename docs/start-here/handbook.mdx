...
The team has various groups that everyone can contribute to. You are allowed to choose more than one subgroup. The team also has special roles that have specific selection criteria to be chosen for.
...
**Special roles within the team**

* Impact Presentation Team  
* Drive Team  
* Strategy and Scouting Specialists

More information for these roles can be found [here](https://docs.deceivers.org/docs/team/)
...
* **Forms**   
  * Submit all required forms by the first official team meeting; the first Saturday in January. This includes Deceivers registration, field trip form, and parents' sign handbook. The registration process can be found on our [website](http://www.deceivers.org).    
